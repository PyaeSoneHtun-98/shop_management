...
function AddCustomer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.message || 'Failed to add customer. Please try again later.');
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="bg-gray-900 p-2 sm:p-6 rounded-lg shadow-sm">
      <div className="mb-6 flex items-center">
        <Link to="/customers" className="flex items-center text-blue-400 hover:text-blue-300 mr-4">
